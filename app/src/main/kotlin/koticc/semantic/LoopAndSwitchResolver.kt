...
internal class LoopAndSwitchResolver {
    ...
    fun resolveLoopsAndSwitches(program: AST.Program): Either<SemanticAnalysisError, AST.Program> = either {
    ...
    private fun resolveDeclaration(declaration: AST.Declaration): Either<SemanticAnalysisError, AST.Declaration> = either {
        when (declaration) {
    ...
    private fun resolveBlockItem(blockItem: AST.BlockItem, context: CurrentContext): Either<SemanticAnalysisError, AST.BlockItem> = either {
        when (blockItem) {
    ...
    private fun resolveStatement(statement: AST.Statement, context: CurrentContext): Either<SemanticAnalysisError, AST.Statement> = either {
        when (statement) {
    ...
    private fun CurrentContext.withNextSwitch(expressionType: Type.Data) = ContextWithSwitch(
    ...
    private fun CurrentContext.withNextLoop() = ContextWithLoop(
